...
class KidsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create kid" do
    assert_difference('Kid.count') do
      post kids_url, params: { kid: { age: @kid.age, fisrtname: @kid.fisrtname, lastname: @kid.lastname } }
    end
  ...
  test "should update kid" do
    patch kid_url(@kid), params: { kid: { age: @kid.age, fisrtname: @kid.fisrtname, lastname: @kid.lastname } }
